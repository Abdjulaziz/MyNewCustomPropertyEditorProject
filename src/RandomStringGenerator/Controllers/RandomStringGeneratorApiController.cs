...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "RandomStringGenerator")]
    public class RandomStringGeneratorApiController : RandomStringGeneratorApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public RandomStringGeneratorApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
