...
namespace RandomStringGenerator.Composers
{
    public class RandomStringGeneratorApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Random String Generator Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<RandomStringGeneratorOperationSecurityFilter>();
            });
        }

        public class RandomStringGeneratorOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("RandomStringGenerator.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
